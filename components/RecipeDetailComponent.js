...
import { View, Alert, Text, RefreshControl, FlatList, SafeAreaView, Image } from 'react-native';
...
export default class RecipeDetailComponent extends Component {
    ...
    render() {
        return <View style={{ flex: 1, backgroundColor: 'cyan' }}>
            <LinearGradient colors={this.state.index % 2 == 1 ? this.colors2 : this.colors1} style={{ flex: 0.6, position: 'absolute', height: 500, width: '100%' }}></LinearGradient>
            <View style={{ flex: 4, /*backgroundColor: 'red' */ }}>
                <SafeAreaView style={{ flex: 1 }}>
                    <View style={{ flex: 1, /*backgroundColor: 'white'*/ }}>
                        <View style={{ flex: 15, flexDirection: 'row', justifyContent: 'space-between' }}>
                            <Image style={{ width: 30, aspectRatio: 1, marginLeft: 30, tintColor: 'white' }} source={require('../assets/menu.png')} ></Image>
                            <Image style={{ width: 30, aspectRatio: 1, marginRight: 30 }} source={require('../assets/heart.png')}></Image>
                        </View>
